...
#define NUM_LEDS 15 // How many leds in your strip?
#define DATA_PIN 5 // What pin is the NeoPixel's data line connected to?
...
void loop()
{
  ...
  else if (cm >= 21) {fill_solid( &(leds[0]), NUM_LEDS /*number of leds*/, CRGB::Black);
     FastLED.show();
  }
